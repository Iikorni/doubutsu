defmodule DoubutsuWeb.ItemControllerTest do
  use DoubutsuWeb.ConnCase

  alias Doubutsu.Things

  @create_attrs %{description: "some description", name: "some name", no_trade: true, picture: "some picture", price: 42, rarity: 42, type: 42, weight: 42}
  ...
  def fixture(:item) do
    {:ok, item} = Things.create_item(@create_attrs)
    item
  end
